...
const Profile = () => {
  const username = getUserName() || "Unknown User";
  const email = getEmail() || "Not provided";
  const fullname = getfullname() || "Not provided";
  const phone = getPhoneNumber() || "Not provided";
